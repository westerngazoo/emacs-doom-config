...
# Confirm the flow
send("signInConfirm", {"userCode": "9B99-0082"}, 3)

# Keep process alive while it waits for the server to finish polling
# We will sleep a long time to make sure the token is actually saved.
time.sleep(600)
